...
@ReactModule(name = RNPictureInPictureModule.NAME)
class RNPictureInPictureModule extends ReactContextBaseJavaModule {
  ...
  public RNPictureInPictureModule(ReactApplicationContext reactContext) {
    super(reactContext);
